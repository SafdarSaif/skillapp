                ...
                <div class="login-card">
                    <div>
                        ...
                        <div class="login-main">
                            ...
                            @endif
                            <form id="" class="theme-form" action="{{ route('login') }}" method="POST">
                                @csrf
                                {{-- <form class="theme-form"> --}}
                                <h4 class="text-center">Welcome to Skill App! 👋</h4>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label" value="{{ __('Password') }}">Password</label>
