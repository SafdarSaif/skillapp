                ...
                <ul class="nav-menus">
                        ...
                        <ul class="notification-dropdown onhover-show-div">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <p><a href="email_inbox.html">Delivery Complete</a><span class="pull-right">45
                                                min</span></p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <li class="profile-nav onhover-dropdown">
                        ...
                        <ul class="profile-dropdown onhover-show-div">
                            ...
                            <li><a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout_form').submit();"><i data-feather="log-in"> </i><span>Logout</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
